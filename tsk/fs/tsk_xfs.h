...
#define XFS_NDADDR      12
#define XFS_NIADDR      3
#define XFS_SBOFF       0 //modified
#define XFS_FS_MAGIC    0x42534658 //modified
#define XFS_MAXNAMLEN   255
#define XFS_MAXPATHLEN   4096
#define XFS_MIN_BLOCK_SIZE   1024
#define XFS_MAX_BLOCK_SIZE   4096
#define XFS_FILE_CONTENT_LEN     ((EXT2FS_NDADDR + EXT2FS_NIADDR) * sizeof(TSK_DADDR_T))
...
#define XFS_STATE_VALID   0x0001  /* unmounted correctly */
#define XFS_STATE_ERROR   0x0002  /* errors detected */

/* Operating System Codes */
#define XFS_OS_LINUX      0
#define XFS_OS_HURD      1
#define   XFS_OS_MASIX      2
#define XFS_OS_FREEBSD   3
#define XFS_OS_LITES      4

/* Revision Levels */
#define XFS_REV_ORIG      0
#define XFS_REV_DYN      1

/* feature flags */
#define XFS_HAS_COMPAT_FEATURE(fs,sb,mask)\
    ((tsk_getu32(fs->endian,sb->s_feature_compat) & mask) != 0)

#define XFS_FEATURE_COMPAT_DIR_PREALLOC   0x0001
#define XFS_FEATURE_COMPAT_IMAGIC_INODES   0x0002
#define XFS_FEATURE_COMPAT_HAS_JOURNAL   0x0004
#define XFS_FEATURE_COMPAT_EXT_ATTR      0x0008
#define XFS_FEATURE_COMPAT_RESIZE_INO   0x0010
#define XFS_FEATURE_COMPAT_DIR_INDEX      0x0020

#define XFS_HAS_INCOMPAT_FEATURE(fs,sb,mask)\
    ((tsk_getu32(fs->endian,sb->s_feature_incompat) & mask) != 0)

#define XFS_FEATURE_INCOMPAT_COMPRESSION   0x0001
#define XFS_FEATURE_INCOMPAT_FILETYPE   0x0002
#define XFS_FEATURE_INCOMPAT_RECOVER      0x0004
#define XFS_FEATURE_INCOMPAT_JOURNAL_DEV   0x0008
#define XFS_FEATURE_INCOMPAT_META_BG         0x0010
#define XFS_FEATURE_INCOMPAT_EXTENTS         0x0040
#define XFS_FEATURE_INCOMPAT_64BIT           0x0080
#define XFS_FEATURE_INCOMPAT_MMP             0x0100
#define XFS_FEATURE_INCOMPAT_FLEX_BG         0x0200
#define XFS_FEATURE_INCOMPAT_EA_INODE        0x0400
#define XFS_FEATURE_INCOMPAT_DIRDATA         0x1000
#define XFS_FEATURE_INCOMPAT_INLINEDATA      0x2000  /* data in inode */
#define XFS_FEATURE_INCOMPAT_LARGEDIR        0x4000  /* >2GB or 3-lvl htree */

#define XFS_HAS_RO_COMPAT_FEATURE(fs,sb,mask)\
    ((tsk_getu32(fs->endian,sb->s_feature_ro_compat) & mask) != 0)

#define XFS_FEATURE_RO_COMPAT_SPARSE_SUPER   0x0001
#define XFS_FEATURE_RO_COMPAT_LARGE_FILE    0x0002
#define XFS_FEATURE_RO_COMPAT_BTREE_DIR     0x0004
#define XFS_FEATURE_RO_COMPAT_HUGE_FILE      0x0008
#define XFS_FEATURE_RO_COMPAT_GDT_CSUM       0x0010
#define XFS_FEATURE_RO_COMPAT_DIR_NLINK      0x0020
#define XFS_FEATURE_RO_COMPAT_EXTRA_ISIZE    0x0040
#define XFS_FEATURE_RO_COMPAT_QUOTA          0x0100
#define XFS_FEATURE_RO_COMPAT_BIGALLOC       0x0200
#define XFS_FEATURE_RO_COMPAT_METADATA_CSUM  0x0400
...
#define XFS_BG_INODE_UNINIT    0x0001  /* Inode table/bitmap not in use */
#define XFS_BG_BLOCK_UNINIT    0x0002  /* Block bitmap not in use */
#define XFS_BG_INODE_ZEROED    0x0004  /* On-disk itable initialized to zero */
 ...
 */
    ...
    typedef struct xfs_extent_header {
...
#define XFS_IN_RESERVED                0x80000000      /* reserved for ext4 lib */
...
#define XFS_EA_MAGIC   0xEA020000
...
#define XFS_EA_IDX_USER                   1
#define XFS_EA_IDX_POSIX_ACL_ACCESS       2
#define XFS_EA_IDX_POSIX_ACL_DEFAULT      3
#define XFS_EA_IDX_TRUSTED                4
#define XFS_EA_IDX_LUSTRE                 5
#define XFS_EA_IDX_SECURITY               6
...
#define XFS_PACL_TAG_USERO   0x01
#define XFS_PACL_TAG_USER   0x02
#define XFS_PACL_TAG_GRPO   0x04
#define XFS_PACL_TAG_GRP   0x08
#define XFS_PACL_TAG_MASK   0x10
#define XFS_PACL_TAG_OTHER   0x20


#define XFS_PACL_PERM_EXEC   0x01
#define XFS_PACL_PERM_WRITE   0x02
#define XFS_PACL_PERM_READ   0x04


    typedef struct {
        uint8_t tag[2];
        uint8_t perm[2];
    } xfs_pos_acl_entry_sh;

    typedef struct {
        uint8_t tag[2];
        uint8_t perm[2];
        uint8_t id[4];
    } xfs_pos_acl_entry_lo;
...
/* Journal Info */
    ...
    typedef struct {
        ...
        xfs_gd *xfs_grp_buf; /* cached group descriptor for 64-bit ext4 r/w shared - lock */
        xfs_gd *grp_buf;     /* cached group descriptor for ext2,ext3,32-bit ext4 r/w shared - lock */

        XFS_GRPNUM_T grp_num;  /* cached group number r/w shared - lock */

        uint8_t *bmap_buf;      /* cached block allocation bitmap r/w shared - lock */
        XFS_GRPNUM_T bmap_grp_num;     /* cached block bitmap nr r/w shared - lock */

        uint8_t *imap_buf;      /* cached inode allocation bitmap r/w shared - lock */
        XFS_GRPNUM_T imap_grp_num;     /* cached inode bitmap nr r/w shared - lock */

        TSK_OFF_T groups_offset;        /* offset to first group desc */
        XFS_GRPNUM_T groups_count;     /* nr of descriptor group blocks */
